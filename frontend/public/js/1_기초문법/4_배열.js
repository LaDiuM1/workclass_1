 ...
 */
 ...
 // 예제2 : 배열 호출
 	...
 	//예제5 : 배열에 요소/데이터 추가
 	배열명.push('체리'); //'체리'추가 : 배열내 마지막 요소/데이터 뒤에 새로운 '체리' 추가
 	console.log(배열명)

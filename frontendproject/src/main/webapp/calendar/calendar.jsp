...
<body>
	...
	<div class="calwrap"><!-- 켈린더 전체구역 -->
	
		<div class="calTop"> <!-- 상단 메뉴 -->
			
			<button onclick="calPrint(-1)" type="button"> < </button> <!-- 이전 달 버튼 -->
			<h3 class="caldate"> 2023년 07월 </h3>	<!-- 현재 년도와 월을 표기하는 구역 -->
			<button onclick="calPrint(1)" type="button"> > </button> <!-- 다음 달 버튼 -->

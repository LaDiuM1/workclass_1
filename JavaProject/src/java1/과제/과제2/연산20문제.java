...
public class 연산20문제 {
	...
	Scanner scanner = new Scanner(System.in);
        ...
        System.out.print("윗변 입력: "); float 윗변 = scanner.nextFloat();
        
        System.out.print("밑변 입력: "); float 및변 = scanner.nextFloat();
        
        System.out.print("높이 입력: "); float 높이 = scanner.nextFloat();
		...
		//------ 문제21 여기에 풀이-------//
	        ...
	        System.out.print("첫 번째 정수 : "); int 정수11 = scanner.nextInt();
	        System.out.print("두 번째 정수 : "); int 정수22 = scanner.nextInt();
	        System.out.print("세 번째 정수 : "); int 정수33 = scanner.nextInt();

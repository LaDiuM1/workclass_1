package java1.과제.과제2.Level1.ex3;
...
public class Level1_3 {
	...
	public static void main(String[] args) {
		...
		System.out.print("input double : "); double h = scanner.nextDouble();		
		
		System.out.println("output boolean : " + a );
		System.out.println("output byte : " + b );
		System.out.println("output char : " + c.charAt(0));
		...
		System.out.println("output double : " + h);
		/* ----------- */
	}
}
/* 
